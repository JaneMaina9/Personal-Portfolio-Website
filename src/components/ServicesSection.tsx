        ...
        <div className="mt-16 bg-blue-50 p-8 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              />
              <div className="p-4">
                <h4 className="font-bold">Zugo – Smart Contract Architecture</h4>
                <p className="text-gray-600 text-sm mt-1">
                  UI/UX Design, Frontend Development
                </p>
                <p className="text-gray-500 text-xs mt-2">
                  Tech: React, TypeScript, Web3, Solidity
                </p>
                <p className="text-sm mt-2">
                  Designed and implemented a seamless developer dashboard where smart contracts automate milestone tracking and ensure transparent payments.
                </p>
              </div>
            </div>

            {/* African Cuisine NFT Platform */}
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <img
              ...
              />
              <div className="p-4">
                <h4 className="font-bold">African Cuisine NFT Platform</h4>
                <p className="text-gray-600 text-sm mt-1">
                  UX Strategy, UI Design, Web3 Integration
                </p>
                <p className="text-gray-500 text-xs mt-2">
                  Tech: React, IPFS, NFT.storage, Ethereum
                </p>
                <p className="text-sm mt-2">
                  Built a recipe registry where chefs tokenize their culinary knowledge, with a developer-friendly portal to encourage collaboration.
                </p>
              </div>
            </div>
